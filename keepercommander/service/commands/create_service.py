...
class CreateService(Command):
    ...
    def get_parser(self):
        ...
        parser.add_argument('-cf', '--cloudflare', type=str, help='cloudflare tunnel token to generate public URL (optional)')
        parser.add_argument('-cfd', '--cloudflare_custom_domain', type=str, help='cloudflare custom domain name (optional)')
