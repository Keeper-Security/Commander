    ...
    def login(params):   # type: (KeeperParams) -> None
        ...
        while not abort_login:
            ...
            if resp.loginState == proto.DEVICE_APPROVAL_REQUIRED:  # client goes to “standard device approval”.
                ...
                encryptedLoginToken, abort_login = LoginV3Flow.handleTwoFactor(params, resp.encryptedLoginToken, resp)
            ...
            try:
                ...
                if u2f_response:
                    ...
                    if type(rs) == bytes:
                        ...
                        return two_fa_validation_rs.encryptedLoginToken, False
                    else:
