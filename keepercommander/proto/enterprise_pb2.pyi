...
class UserUpdateStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    USER_UPDATE_INVALID_STATE: _ClassVar[UserUpdateStatus]
...
class UserLockStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    UNKNOWN_LOCK_STATUS: _ClassVar[UserLockStatus]
    LOCKED: _ClassVar[UserLockStatus]
    DISABLED: _ClassVar[UserLockStatus]
    UNLOCKED: _ClassVar[UserLockStatus]
    DELETED: _ClassVar[UserLockStatus]
    CANT_BE_PENDING: _ClassVar[UserLockStatus]

class ExternalCloudSecretsStoreType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    UNKNOWN_STORE_TYPE: _ClassVar[ExternalCloudSecretsStoreType]
...
WOULD_LOCK_SELF: RoleUserModifyStatus
...
USER_UPDATE_BAD_REQUEST: UserUpdateStatus
USER_UPDATE_DUPLICATE: UserUpdateStatus
USER_UPDATE_INVALID_STATE: UserUpdateStatus
USER_UPDATE_FAILED: UserUpdateStatus
USER_UPDATE_ERROR: UserUpdateStatus
OK: AuditUserStatus
...
UNKNOWN_LOCK_STATUS: UserLockStatus
LOCKED: UserLockStatus
DISABLED: UserLockStatus
UNLOCKED: UserLockStatus
DELETED: UserLockStatus
CANT_BE_PENDING: UserLockStatus
UNKNOWN_STORE_TYPE: ExternalCloudSecretsStoreType
AWS_SECRETS_MANAGER: ExternalCloudSecretsStoreType
AZURE_KEY_VAULT: ExternalCloudSecretsStoreType
GOOGLE_SECRET_MANAGER: ExternalCloudSecretsStoreType
...
class RoleUserAddKeys(_message.Message):
    __slots__ = ("enterpriseUserId", "treeKey", "roleAdminKey", "typedTreeKey")
    ENTERPRISEUSERID_FIELD_NUMBER: _ClassVar[int]
    TREEKEY_FIELD_NUMBER: _ClassVar[int]
    ROLEADMINKEY_FIELD_NUMBER: _ClassVar[int]
    TYPEDTREEKEY_FIELD_NUMBER: _ClassVar[int]
    enterpriseUserId: int
    treeKey: str
    roleAdminKey: str
    typedTreeKey: TypedKey
    def __init__(self, enterpriseUserId: _Optional[int] = ..., treeKey: _Optional[str] = ..., roleAdminKey: _Optional[str] = ..., typedTreeKey: _Optional[_Union[TypedKey, _Mapping]] = ...) -> None: ...
...
class LoginToMcResponse(_message.Message):
    __slots__ = ("encryptedSessionToken", "encryptedTreeKey", "keyTypeId", "forbidKeyType2")
...
class PrivilegesByManagedNode(_message.Message):
    __slots__ = ("managedNodeId", "roleId", "privileges")
    MANAGEDNODEID_FIELD_NUMBER: _ClassVar[int]
    ROLEID_FIELD_NUMBER: _ClassVar[int]
    PRIVILEGES_FIELD_NUMBER: _ClassVar[int]
    managedNodeId: int
    roleId: int
    privileges: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, managedNodeId: _Optional[int] = ..., roleId: _Optional[int] = ..., privileges: _Optional[_Iterable[str]] = ...) -> None: ...
...
class LicenseAddOn(_message.Message):
    __slots__ = ("name", "enabled", "isTrial", "expiration", "created", "seats", "activationTime", "includedInProduct", "apiCallCount", "tierDescription", "seatsAllocated", "nhiTierAddOnId")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    NHITIERADDONID_FIELD_NUMBER: _ClassVar[int]
    name: str
    enabled: bool
    isTrial: bool
    expiration: int
...
class UserUpdate(_message.Message):
    __slots__ = ("enterpriseUserId", "nodeId", "encryptedData", "keyType", "fullName", "jobTitle", "email", "inviteeLocale", "encryptedDataString")
    ENTERPRISEUSERID_FIELD_NUMBER: _ClassVar[int]
    NODEID_FIELD_NUMBER: _ClassVar[int]
    ENCRYPTEDDATA_FIELD_NUMBER: _ClassVar[int]
    KEYTYPE_FIELD_NUMBER: _ClassVar[int]
    ...
    ENCRYPTEDDATASTRING_FIELD_NUMBER: _ClassVar[int]
    enterpriseUserId: int
    nodeId: int
    encryptedData: bytes
    keyType: EncryptedKeyType
    ...
    email: str
    inviteeLocale: str
    encryptedDataString: str
    def __init__(self, enterpriseUserId: _Optional[int] = ..., nodeId: _Optional[int] = ..., encryptedData: _Optional[bytes] = ..., keyType: _Optional[_Union[EncryptedKeyType, str]] = ..., fullName: _Optional[str] = ..., jobTitle: _Optional[str] = ..., email: _Optional[str] = ..., inviteeLocale: _Optional[str] = ..., encryptedDataString: _Optional[str] = ...) -> None: ...
...
class UserUpdateResult(_message.Message):
    __slots__ = ("enterpriseUserId", "status", "errorMessage", "additionalInfo")
    ENTERPRISEUSERID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ERRORMESSAGE_FIELD_NUMBER: _ClassVar[int]
    ...
    errorMessage: str
    additionalInfo: str
    def __init__(self, enterpriseUserId: _Optional[int] = ..., status: _Optional[_Union[UserUpdateStatus, str]] = ..., errorMessage: _Optional[str] = ..., additionalInfo: _Optional[str] = ...) -> None: ...
...
class AuditUserRecord(_message.Message):
    ...
    ENCRYPTEDDATA_FIELD_NUMBER: _ClassVar[int]
    SHARED_FIELD_NUMBER: _ClassVar[int]
    ISDRIVERECORD_FIELD_NUMBER: _ClassVar[int]
    recordUid: bytes
    encryptedData: bytes
    shared: bool
    isDriveRecord: bool
...
class DrivePermission(_message.Message):
    ...
    def __init__(self, owner: _Optional[bool] = ..., denied: _Optional[bool] = ..., canEdit: _Optional[bool] = ..., canShare: _Optional[bool] = ..., isShareAdmin: _Optional[bool] = ..., accessType: _Optional[_Union[_folder_pb2.AccessType, str]] = ..., folderPermissions: _Optional[_Union[_folder_pb2.FolderPermissions, _Mapping]] = ...) -> None: ...
...
class RolesByTeam(_message.Message):
    __slots__ = ("teamUid", "roleId")
    TEAMUID_FIELD_NUMBER: _ClassVar[int]
    ROLEID_FIELD_NUMBER: _ClassVar[int]
    teamUid: bytes
    roleId: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, teamUid: _Optional[bytes] = ..., roleId: _Optional[_Iterable[int]] = ...) -> None: ...

class LockUsersRequest(_message.Message):
    __slots__ = ("lockEnterpriseUserIds", "disableEnterpriseUserIds", "unlockEnterpriseUserIds", "deleteIfPending")
    LOCKENTERPRISEUSERIDS_FIELD_NUMBER: _ClassVar[int]
    DISABLEENTERPRISEUSERIDS_FIELD_NUMBER: _ClassVar[int]
    UNLOCKENTERPRISEUSERIDS_FIELD_NUMBER: _ClassVar[int]
    DELETEIFPENDING_FIELD_NUMBER: _ClassVar[int]
    lockEnterpriseUserIds: _containers.RepeatedScalarFieldContainer[int]
...
class LockUsersResponse(_message.Message):
    ...
    response: _containers.RepeatedCompositeFieldContainer[LockUserResponse]
    def __init__(self, response: _Optional[_Iterable[_Union[LockUserResponse, _Mapping]]] = ...) -> None: ...

class LockUserResponse(_message.Message):
    __slots__ = ("enterpriseUserId", "status", "errorMessage")
    ENTERPRISEUSERID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ERRORMESSAGE_FIELD_NUMBER: _ClassVar[int]
    enterpriseUserId: int
    ...
    errorMessage: str
    def __init__(self, enterpriseUserId: _Optional[int] = ..., status: _Optional[_Union[UserLockStatus, str]] = ..., errorMessage: _Optional[str] = ...) -> None: ...
