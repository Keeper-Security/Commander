...
class LoginToMcResponse(_message.Message):
    __slots__ = ["encryptedSessionToken", "encryptedTreeKey", "keyTypeId"]
    ...
    keyTypeId: int
    def __init__(self, encryptedSessionToken: _Optional[bytes] = ..., encryptedTreeKey: _Optional[str] = ..., keyTypeId: _Optional[int] = ...) -> None: ...
