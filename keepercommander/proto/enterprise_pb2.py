...
SharingAdmin = _reflection.GeneratedProtocolMessageType('SharingAdmin', (_message.Message,), {
  'DESCRIPTOR' : _SHARINGADMIN,
  '__module__' : 'enterprise_pb2'
  # @@protoc_insertion_point(class_scope:Enterprise.SharingAdmin)
  })
