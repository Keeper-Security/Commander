...
class Cost(_message.Message):
    ...
    currency: Currency
    contactSales: bool
    def __init__(self, amount: _Optional[float] = ..., amountPer: _Optional[_Union[Cost.AmountPer, str]] = ..., currency: _Optional[_Union[Currency, str]] = ..., contactSales: _Optional[bool] = ...) -> None: ...
...
class CustomerCaptureRequest(_message.Message):
    ...
    mlLabels: str
    def __init__(self, pageUrl: _Optional[str] = ..., tree: _Optional[str] = ..., hash: _Optional[str] = ..., image: _Optional[str] = ..., pageLoadTime: _Optional[str] = ..., keyId: _Optional[str] = ..., test: _Optional[bool] = ..., issueType: _Optional[str] = ..., notes: _Optional[str] = ..., extensionVersion: _Optional[str] = ..., aiAutofillStatus: _Optional[str] = ..., mlLabels: _Optional[str] = ...) -> None: ...
