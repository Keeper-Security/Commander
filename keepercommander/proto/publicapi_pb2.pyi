...
class PublicApiToken(_message.Message):
    ...
    def __init__(self, enterprisePublicApiTokenId: _Optional[int] = ..., enterprise_id: _Optional[int] = ..., name: _Optional[str] = ..., token: _Optional[str] = ..., active: _Optional[bool] = ..., issuedDate: _Optional[int] = ..., expirationDate: _Optional[int] = ..., integrations: _Optional[_Iterable[_Union[Integrations, _Mapping]]] = ...) -> None: ...
...
class PublicApiTokenResponse(_message.Message):
    ...
    expirationDate: int
    integrations: _containers.RepeatedCompositeFieldContainer[Integrations]
    def __init__(self, enterprise_id: _Optional[int] = ..., name: _Optional[str] = ..., token: _Optional[str] = ..., active: _Optional[bool] = ..., issuedDate: _Optional[int] = ..., expirationDate: _Optional[int] = ..., integrations: _Optional[_Iterable[_Union[Integrations, _Mapping]]] = ...) -> None: ...
