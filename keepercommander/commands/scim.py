...
from ..scim.data_sources import AdCrmDataSource, LocalCrmDataSource, GoogleCrmDataSource
...
class ScimPushCommand(EnterpriseCommand):
    ...
    def execute(self, params, target=None, **kwargs):
        ...
        if source == 'google':
            ...
            data_source = AdCrmDataSource(ad_url, ad_user, ad_password, scim_groups, use_netbios_domain=False)
        elif source == 'record':
