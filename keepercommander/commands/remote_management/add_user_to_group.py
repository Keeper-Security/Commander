...
class GatewayActionRmAddUserToGroupCommandInputs:
...
class GatewayActionRmAddUserToGroupCommand(GatewayAction):

    def __init__(self, inputs: GatewayActionRmAddUserToGroupCommandInputs, conversation_id=None):
...
class RmAddUserToGroupCommand(PAMGatewayActionDiscoverCommandBase):
    ...
    def get_parser(self):
        return RmAddUserToGroupCommand.parser
    ...
    def execute(self, params: KeeperParams, **kwargs):
        ...
        action_inputs = GatewayActionRmAddUserToGroupCommandInputs(
        ...
        router_response = router_send_action_to_gateway(
            params=params,
            gateway_action=GatewayActionRmAddUserToGroupCommand(
        ...
        if data is None:
            ...
            print(f"{bcolors.FAIL}Could not add user to group: {error}{bcolors.ENDC}")
            return

        print("")
        print(f"{bcolors.OKGREEN}User added to group.{bcolors.ENDC}")
        print("")
