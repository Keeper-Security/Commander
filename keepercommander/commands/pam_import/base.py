...
def _validate_file_path(file_path):
    ...
    Rejects paths containing '..' components. Note: this does not confine
    access to a specific directory -- absolute paths are accepted if the
    file exists. Symlinks are followed by Path.resolve().
    """
...
class PamScriptsObject():
    ...
    def load(cls, data: Optional[Union[str, list]]) -> PamScriptsObject:
        ...
        except json.JSONDecodeError as e: logging.error(f"Pam Scripts: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
...
class PamScriptObject():
    ...
    def validate(self):
        return _validate_file_path(self.file)

    @classmethod
    def load(cls, data: Union[str, dict]) -> PamScriptObject:
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"PAM script: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
...
class PamAttachmentsObject():
    ...
    def load(cls, data: Optional[Union[str, list]]) -> PamAttachmentsObject:
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"PAM Attachments: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not(data and isinstance(data, list)): return obj
...
class PamAttachmentObject():
    ...
    def load(cls, data: Union[str, dict]) -> PamAttachmentObject:
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"File attachment: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
...
class PamRotationScheduleObject():
    ...
    def load(cls, data: Union[str, dict]) -> PamRotationScheduleObject:
        ...
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Rotation schedule: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
        ...
        if obj.type.lower() == "cron":
            ...
            if obj.cron:  # validate
                try:
                    ...
                    logging.error(f"CRON field has unexpected structure ({e.__class__.__name__}): {e}")
                    parsed_cron = {}
                if not (parsed_cron and parsed_cron.get("time", "")):
                    logging.error("Failed to validate CRON schedule expression")
            tz = data.get("tz", None)
...
class PamRotationSettingsObject():
    ...
    def load(cls, data: Optional[Union[str, dict]], rotation_params: Optional[PamRotationParams] = None) -> PamRotationSettingsObject:
        ...
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Rotation settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class DagSettingsObject():
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"DAG settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class DagJitSettingsObject():
    ...
    def load(cls, data: Union[str, dict]) -> Optional['DagJitSettingsObject']:
        ...
        try:
            ...
            logging.error(f"JIT settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
            return None
...
class DagAiSettingsObject():
    ...
    def load(cls, data: Union[str, dict]) -> Optional['DagAiSettingsObject']:
        ...
        try:
            ...
            logging.error(f"AI settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
            return None
...
class PamUserObject():
    ...
    def load(cls, data: Union[str, dict], rotation_params: Optional[PamRotationParams] = None):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"PAM User: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class LoginUserObject():
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Record type `login`: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class PamBaseMachineParser():
    ...
    def load(cls, record_type: str, data: Union[str, dict]):
        ...
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Record type '{record_type}': invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
        ...
        if psd:
            ...
            if not obj.pam_settings:
                logging.error(f"{obj.type}: failed to load PAM Settings")
...
class PamMachineObject():
    ...
    def load(cls, data: Union[str, dict], rotation_params: Optional[PamRotationParams] = None):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Record type 'pamMachine': invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class PamDatabaseObject():
    ...
    def load(cls, data: Union[str, dict], rotation_params: Optional[PamRotationParams] = None):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Record type 'pamDatabase': invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class PamDirectoryObject():
    ...
    def load(cls, data: Union[str, dict], rotation_params: Optional[PamRotationParams] = None):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Record type 'pamDirectory': invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class PamRemoteBrowserObject():
    ...
    def load(cls, data: Union[str, dict], rotation_params: Optional[PamRotationParams] = None):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Record type 'pamRemoteBrowser': invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class ClipboardConnectionSettings:
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Clipboard Connection Settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class SFTPRootDirectorySettings:
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"SFTP Root Directory Settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class SFTPConnectionSettings(SFTPRootDirectorySettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"SFTP Connection Settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class TerminalDisplayConnectionSettings:
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Terminal Display Connection Settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class BaseConnectionSettings:
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Base Connection Settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class ConnectionSettingsRDP(BaseConnectionSettings, ClipboardConnectionSettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Connection Settings RDP: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class ConnectionSettingsHTTP(BaseConnectionSettings, ClipboardConnectionSettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Connection Settings HTTP: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class ConnectionSettingsVNC(BaseConnectionSettings, ClipboardConnectionSettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Connection Settings VNC: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class ConnectionSettingsTelnet(BaseConnectionSettings, ClipboardConnectionSettings, TerminalDisplayConnectionSettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Connection Settings Telnet: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class ConnectionSettingsSSH(BaseConnectionSettings, ClipboardConnectionSettings, TerminalDisplayConnectionSettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Connection Settings SSH: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class ConnectionSettingsKubernetes(BaseConnectionSettings, TerminalDisplayConnectionSettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Connection Settings K8S: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class BaseDatabaseConnectionSettings(BaseConnectionSettings, ClipboardConnectionSettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Database Connection Settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class ConnectionSettingsSqlServer(BaseDatabaseConnectionSettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"SQLServer Connection Settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class ConnectionSettingsPostgreSQL(BaseDatabaseConnectionSettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"PostgreSQL Connection Settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class ConnectionSettingsMySQL(BaseDatabaseConnectionSettings):
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"MySQL Connection Settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class PamPortForwardSettings:
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"Port Forward Settings: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class PamRemoteBrowserSettings:
    ...
    def load(cls, data: Optional[Union[str, dict]]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"PAM RBI Settings field: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
...
class PamSettingsFieldData:
    ...
    def load(cls, data: Union[str, dict]):
        obj = cls()
        try: data = json.loads(data) if isinstance(data, str) else data
        except json.JSONDecodeError as e: logging.error(f"PAM Settings Field: invalid JSON at line {e.lineno}, col {e.colno} -- {e.msg}")
        if not isinstance(data, dict): return obj
