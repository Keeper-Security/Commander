...
aws_group.add_argument('--uss-enabled', dest='universal_secrets_enabled', action='store', help='Enable Universal Secrets')
aws_group.add_argument('--uss-dry-run', dest='universal_secrets_dry_run_workflow', action='store', help='Use Dry Run Workflow for Universal Secrets')
aws_group.add_argument('--uss-folder-uid', dest='universal_secrets_folder_uid', action='store', help='Universal Secrets Folder UID')
