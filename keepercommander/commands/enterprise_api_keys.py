...
Examples:
  ...
  public-api-key generate --name "CSPM Integration" --integrations "CSPM:2" --expires 30d
...
Examples: 
  ...
  --integrations "CSPM:2"                    # CSPM role with read-write access
...
class ApiKeyCommand(GroupCommand):
    ...
    def print_help(self, **kwargs):
        ...
        print('  public-api-key generate --name "CSPM Tool" --integrations "CSPM:2" --expires 30d')
        print()
    ...
    def execute(self, params, **kwargs):
        ...
        try:
            ...
            if not integrations_str:
                print("At least one integration is required. Example: --integrations 'SIEM:2', --integrations 'CSPM:2', or --integrations 'BILLING:2'")
                return
