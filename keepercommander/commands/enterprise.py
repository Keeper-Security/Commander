...
device_approve_parser = argparse.ArgumentParser(prog='device-approve', description='Approve user devices')
device_approve_parser.add_argument('--reload', dest='reload', action='store_true', help='Reload of device information')
device_approve_parser.add_argument('--approve', dest='approve', action='store_true', help='Approve device.')
device_approve_parser.add_argument('--deny', dest='deny', action='store_true', help='Deny device.')
device_approve_parser.add_argument('device', type=str, nargs='?', help='User email or device ID')
