...
device_approve_parser.add_argument('--reload', dest='reload', action='store_true', help='reload list of device approval requests')
...
device_approve_parser.add_argument('--check-ip', dest='check_ip', action='store_true', help='approve only devices with matching IP address')
