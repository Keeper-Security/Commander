    ...
    def execute(self, params: KeeperParams, **kwargs):
        ...
        if machine_uid is not None:
            ...
            if machine_data is None:
                print(self._f("Could not get data from the resource."))
                return

            if machine_data.no_update_services:
                machine_data.no_update_services = False
            ...
            if user_data is None:
                print(self._f("Could not get data from the user."))
                return

            if user_data.no_update_services:
                user_data.no_update_services = False
