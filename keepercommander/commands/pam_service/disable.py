...
class PAMActionServiceDisableCommand(PAMGatewayActionDiscoverCommandBase):
    ...
    def execute(self, params: KeeperParams, **kwargs):
        ...
        if machine_uid is not None:
            ...
            if not machine_data.rotation_settings.no_update_services:
                machine_data.rotation_settings.no_update_services = True
            ...
            if not user_data.rotation_settings.no_update_services:
                user_data.rotation_settings.no_update_services = True
